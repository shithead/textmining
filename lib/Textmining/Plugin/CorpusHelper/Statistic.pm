...
package Textmining::Plugin::CorpusHelper::Statistic;
...
* L<Textmining::Plugin::CorpusHelper::Statistic::LLR>

=cut

use Mojo::Base 'Mojolicious::Plugin';
use Textmining::Plugin::CorpusHelper::Count;
use Textmining::Plugin::CorpusHelper::Statistic::CHI2;
use Textmining::Plugin::CorpusHelper::Statistic::LLR;
...
sub collocation ($$$) {
    ...
    my $stat;
    if ($stat_id =~ qr/llr/) {
        $stat = Textmining::Plugin::CorpusHelper::Statistic::LLR->new
    } elsif ($stat_id =~ qr/chi2/) {
        $stat = Textmining::Plugin::CorpusHelper::Statistic::CHI2->new;
    } else {
